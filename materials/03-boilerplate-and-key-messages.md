...
| Say | Not |
|---|---|
| children and young people with visual impairment | the blind / blind kids |
| audio-first learning | learning without Braille *(defines us by an absence)* |
| a pathway towards livelihood | we get students jobs |
| the project is completed and formally closed | the project failed / ran out of money |
| documented qualitatively | *(don't invent numbers we don't have)* |
...
- ❌ Any FCRA registration — we do not have it and cannot accept foreign contributions.
- ❌ Any government affiliation, accreditation or empanelment.
- ❌ Permanent 12A/80G status — ours is **provisional**, valid to TY 2028-29.
- ❌ Partnership with any organisation that has not confirmed it in writing.
- ❌ Participant or impact numbers that are not in a facilitator's records.
