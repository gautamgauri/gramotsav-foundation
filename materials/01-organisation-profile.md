# Gramotsav Foundation — Organisation Profile

*Version 1.0 · 31 August 2026 · For funders, partners and due diligence*
...
1. Preserve, promote and revitalise the folk traditions and cultural heritage of rural and indigenous Indian communities, and build awareness and appreciation for them across diverse communities.
2. Design and implement programmes for holistic development through inclusive platforms that strengthen traditional cultural identity and practices.
...
> **LISTEN → LEARN → PRACTISE → CREATE → COLLABORATE → PERFORM → IMPACT**

We measure progress by how far along that arc a young person travels.
...
| | |
|---|---|
| Legal form | Company limited by shares, licensed under Section 8, Companies Act 2013 |
...
| FCRA | **Not registered** — cannot accept foreign contributions |
...
- All expenditure runs against a Board-approved budget.
- **Cash procurement is prohibited at every level**, for any amount.
- Procurement above ₹10,000 requires three quotations and written Board approval; above ₹25,000 requires a Board-approved Purchase Committee.
- Monthly project-wise accounts, fund position and bank reconciliation to the Board by the 5th.
- Advances must be settled before the next advance is released.
- Director and member reimbursements require Board approval, not a Director's own sign-off.
